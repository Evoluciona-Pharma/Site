    ...
    <div className="flex flex-col bg-white">
      ...
      <section className="flex flex-col items-center bg-[#E7EBF3] px-14 pb-16 pt-16 text-center">
        ...
        {/* The rise animation makes this a stacking context, so the field colour has
            to live here or multiply has no backdrop and the white box stays. */}
      ...
      <Reveal as="section" className="grid grid-cols-4 bg-white px-14 py-14">
        {SPEC_STRIP.map((s, i) => (
          <div key={s.label} className={i > 0 ? 'border-l border-line pl-8' : 'pr-8'}>
      ...
      {/* 7 · Editorial */}
      <Reveal as="section" className="grid grid-cols-[520px_1fr] items-start gap-16 bg-white px-14 py-20">
